export const endpoints = {
  ...
  matchChallengesOpen: "/api/match-challenges/open",
  organizerRequests: "/api/organizer-requests",
  organizerRequestsMine: "/api/organizer-requests/mine",
  organizerRequestApprove: (id: number) => `/api/organizer-requests/${id}/approve`,
  organizerRequestDecline: (id: number) => `/api/organizer-requests/${id}/decline`,
  organizerRequestCancel: (id: number) => `/api/organizer-requests/${id}/cancel`,
