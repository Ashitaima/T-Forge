...
namespace TForge.Migrations
{
    ...
    [Migration("20260820181930_OrganizerRequests")]
    partial class OrganizerRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TForge.Models.Duel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("ChallengerPlayerId", "OpponentPlayerId")
                        .IsUnique()
            ...
            modelBuilder.Entity("TForge.Models.OrganizerRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("organizer_requests", (string)null);
                });
            ...
            modelBuilder.Entity("TForge.Models.Player", b =>
                {
                    ...
                    b.Property<bool>("IsAgeHidden")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsCountryHidden")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("TForge.Models.PlayerGameProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("player_game_profiles", (string)null);
                });
            ...
            modelBuilder.Entity("TForge.Models.Duel", b =>
                {
                    b.HasOne("TForge.Models.Player", "ChallengerPlayer")
                        .WithMany()
                        .HasForeignKey("ChallengerPlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TForge.Models.Player", "OpponentPlayer")
                        .WithMany()
                        .HasForeignKey("OpponentPlayerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("ChallengerPlayer");
